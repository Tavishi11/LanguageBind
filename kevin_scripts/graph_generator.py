...
if __name__ == "__main__":
    ...
    # saveSoftmaxGraph("/home/cod022/models/LanguageBind/intent_dataset/merged_datatset.json", "query_difficult_softmax")
    # saveInverseTimeSoftmaxGraph("/home/cod022/models/LanguageBind/intent_dataset/merged_datatset.json", "query_difficult_softmax")
    # saveSoftmaxGraph("/home/cod022/models/LanguageBind/intent_dataset/merged_datatset.json", "query_difficult_prompt_rewritting_ablation")
    # saveInverseTimeSoftmaxGraph("/home/cod022/models/LanguageBind/intent_dataset/merged_datatset.json", "query_difficult_prompt_rewritting_ablation")
    # saveSoftmaxGraph("intent_dataset/merged_dataset_matched_prompts.json", "query_moderate_rewritten_softmax")
    # saveInverseTimeSoftmaxGraph("intent_dataset/merged_dataset_matched_prompts.json", "query_moderate_rewritten_softmax")
    saveSoftmaxGraph("intent_dataset/merged_dataset_matched_prompts.json", "query_difficult_rewritten_softmax")
    saveInverseTimeSoftmaxGraph("intent_dataset/merged_dataset_matched_prompts.json", "query_difficult_rewritten_softmax")